...
import com.gestionePrenotazioni.service.PrenotazionePostazioneService;
...
public class APIGestionePrenotazioniRunner implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		List<Postazione> listaP = postazioneService.cercaPostazionePerTipoCitta("Milano", TipoPostazione.Privato);
		 listaP.forEach(p->System.out.println("Postazione situata a: " + p.getEdificio().getCitta() + 
		 " [" +p.getDescrizione()+ ", numero massimo persone: " +p.getNumeroMassimoOccupanti()+
